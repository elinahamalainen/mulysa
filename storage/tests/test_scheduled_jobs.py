...
class TestScheduledJobs(TestCase):
    ...
    # ----------------------------------------------------------------------
    # 1) EXPIRING PENDING RESERVATIONS
    # ----------------------------------------------------------------------
    ...
    def test_expire_does_not_touch_non_pending(self):
        """ACTIVE / COMPLETED / EXPIRED must remain unchanged."""
    ...
    # ----------------------------------------------------------------------
    # 2) COMPLETING ACTIVE FINISHED RESERVATIONS
    # ----------------------------------------------------------------------
    ...
    # ----------------------------------------------------------------------
    # 3) BOTH JOBS TOGETHER (same behavior as daily_job)
    # ----------------------------------------------------------------------
